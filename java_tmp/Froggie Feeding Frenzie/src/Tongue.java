...
/**
 * An instantiable class maintains data about the Tongue use by the Frog in the
 * Froggie Feeding Frenzie game. Graphically this is represented by a line. This
 * tongue can move with the Frog and extend when active.
 * 
 * @author Michelle
 */
public class Tongue {
  ...
  /**
   * Constructor for a new tongue that starts and ends at the given point. The
   * hitbox is centered at the end point and has dimentions 30 x 30. By default
  ...
  /**
   * Moves the coordinates of the endpoint and the center of the hitbox of this
   * tongue to the x,y-values given.
   * 
  ...
  public void draw() {
    if (isActive) {
      ...
      // change color back to black, otherwise other things we draw after this will be
      // pink
      processing.stroke(0, 0, 0);
      processing.strokeWeight(1); // reset line thickness
      // hitbox.visualizeHitbox(); //comment in to help see the hitbox for debugging
      // purposes
    }
  }

  /**
   * Determines whether or not the end of the tongue reaches the top of the
   * screen.
   * 
   * @return true if the endpoint of the tongue is at the top of the screen, false
   *         otherwise
   */
  ...
  /**
   * Resets the tongue to its default state by moving everything back to the
   * starting point.
   */
  public void reset() {
